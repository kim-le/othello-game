...
public class RandomVSRandom {
	...
	public static void main(String[] args) {
		...
		// H0: The probability of P1 or P2 winning using the Random Strategy is equal,
		// so .5 and .5
		// Ha: When both P1 and P2 are playing the RandomStrategy, P2 has a real
		// advantage
		// and so is more likely to win.

		// We are interested in how likely it is that H0 is true and yet we arrive at
		// experimental probabilities that are as extreme or more than the ones we
		// measured.
	...
	/**
	 * Run an experiment, flipping a coin num times. Record the experimental
	 * probability of heads and of tails.
	 * 
	 * @param num
	 */
