...
import ca.utoronto.utm.othello.viewcontroller.PlayerVisitor;
 ...
 *
 */
public class Othello extends Observable { //implements OthelloElement {
	public static final int DIMENSION = 8; // This is an 8x8 game

	public OthelloBoard board = new OthelloBoard(Othello.DIMENSION);
	public OthelloBoard lastBoard  = new OthelloBoard(Othello.DIMENSION);
	...
	/**
	 * return H, R, I, or G depending on the player controller type.
	 * 
	 * @return 'H', 'R', 'I', or 'G'
	 */
	public char getP1() {
	...
	/**
	 * set P1 depending on the player controller type.
	 * @param type		H, R, I, or G 
	 */
	public void setP1(char type) {
		this.P1 = type;
	}
	
	/**
	 * set P2 depending on the player controller type.
	 * @param type		H, R, I, or G 
	 */
	public void setP2(char type) {
		this.P2 = type;
	}
	...
	/**
	 * Accept PlayerVisitor to visit (and make a move)
	 * @param visitor	the visiting PlayerVisitor
	 */
	...
	/*
	 * Set the current player to the other one
	 * 
	 * This method is specifically made for the undo/redo functionality
	 */
